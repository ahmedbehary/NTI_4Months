...
void lcd_vidSendCmd(lcd_cmd_t cmd)
{
	...
	dio_vidWriteChannel(LCD_D4_PORT,LCD_D4_CHANNEL,READ_BIT(cmd,4));
	dio_vidWriteChannel(LCD_D4_PORT,LCD_D5_CHANNEL,READ_BIT(cmd,5));
	dio_vidWriteChannel(LCD_D4_PORT,LCD_D6_CHANNEL,READ_BIT(cmd,6));
	dio_vidWriteChannel(LCD_D4_PORT,LCD_D7_CHANNEL,READ_BIT(cmd,7));
	
	enablePulse();
	
	dio_vidWriteChannel(LCD_D4_PORT,LCD_D4_CHANNEL,READ_BIT(cmd,0));
	dio_vidWriteChannel(LCD_D4_PORT,LCD_D5_CHANNEL,READ_BIT(cmd,1));
	dio_vidWriteChannel(LCD_D4_PORT,LCD_D6_CHANNEL,READ_BIT(cmd,2));
	dio_vidWriteChannel(LCD_D4_PORT,LCD_D7_CHANNEL,READ_BIT(cmd,3));
...
void lcd_vidSendData(u8 data)
{
	...
	dio_vidWriteChannel(LCD_D4_PORT,LCD_D4_CHANNEL,READ_BIT(data,4));
	dio_vidWriteChannel(LCD_D4_PORT,LCD_D5_CHANNEL,READ_BIT(data,5));
	dio_vidWriteChannel(LCD_D4_PORT,LCD_D6_CHANNEL,READ_BIT(data,6));
	dio_vidWriteChannel(LCD_D4_PORT,LCD_D7_CHANNEL,READ_BIT(data,7));
	
	enablePulse();
	
	dio_vidWriteChannel(LCD_D4_PORT,LCD_D4_CHANNEL,READ_BIT(data,0));
	dio_vidWriteChannel(LCD_D4_PORT,LCD_D5_CHANNEL,READ_BIT(data,1));
	dio_vidWriteChannel(LCD_D4_PORT,LCD_D6_CHANNEL,READ_BIT(data,2));
	dio_vidWriteChannel(LCD_D4_PORT,LCD_D7_CHANNEL,READ_BIT(data,3));
