...
{
	/*	show me your code */
	dio_level_t standard_value = STD_LOW;
	switch(port){
		case DIO_PORTA:
			standard_value = READ_BIT(DIO_PINA_REG,channel);
			break;
		case DIO_PORTB:
			standard_value = READ_BIT(DIO_PINB_REG,channel);
			break;
		case DIO_PORTC:
			standard_value = READ_BIT(DIO_PINC_REG,channel);
			break;
		case DIO_PORTD:
			standard_value = READ_BIT(DIO_PIND_REG,channel);
			break;
		default: /* Nothing */
			break;				
	}
